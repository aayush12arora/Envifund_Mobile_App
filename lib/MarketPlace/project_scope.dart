...
class ProjectDes extends StatefulWidget {
 final  BigInt id;
 final Project project;
  const ProjectDes({super.key, required this.id, required this.project});

  @override
  State<ProjectDes> createState() => _ProjectDesState();
}

class _ProjectDesState extends State<ProjectDes> {
