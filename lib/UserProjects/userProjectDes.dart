...
class UserProjectDes extends StatefulWidget {
  final  BigInt id;
  final Project project;
  const UserProjectDes({super.key, required this.id, required this.project});

  @override
  State<UserProjectDes> createState() => _UserProjectDesState();
}

class _UserProjectDesState extends State<UserProjectDes> {
